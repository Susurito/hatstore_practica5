	...
	private function add_general_section_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options'     => array(
					'h1'   => array(
						'title' => __( 'H1', 'premium-addons-for-elementor' ),
						'icon'  => 'eicon-editor-h1',
					),
					'h2'   => array(
						'title' => __( 'H2', 'premium-addons-for-elementor' ),
						'icon'  => 'eicon-editor-h2',
					),
					'h3'   => array(
						'title' => __( 'H3', 'premium-addons-for-elementor' ),
						'icon'  => 'eicon-editor-h3',
					),
					'h4'   => array(
						'title' => __( 'H4', 'premium-addons-for-elementor' ),
						'icon'  => 'eicon-editor-h4',
					),
					'h5'   => array(
						'title' => __( 'H5', 'premium-addons-for-elementor' ),
						'icon'  => 'eicon-editor-h5',
					),
					'h6'   => array(
						'title' => __( 'H6', 'premium-addons-for-elementor' ),
						'icon'  => 'eicon-editor-h6',
					),
					'div'  => array(
						'title' => __( 'div', 'premium-addons-for-elementor' ),
						'text'  => 'div',
					),
					'span' => array(
						'title' => __( 'span', 'premium-addons-for-elementor' ),
						'text'  => 'span',
					),
					'p'    => array(
						'title' => __( 'P', 'premium-addons-for-elementor' ),
						'text'  => 'P',
					),
				),
				'default'     => 'h4',
